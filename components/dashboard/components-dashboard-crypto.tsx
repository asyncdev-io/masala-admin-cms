          ...
          <div className="flex-wrap items-center border-b border-[#ebedf2] p-4 dark:border-[#191e3a] md:flex">
            <div className="flex flex-1 items-start ltr:pr-4 rtl:pl-4">
              <button
                onClick={() => setIsShowCryptoMenu(!isShowCryptoMenu)}
                type="button"
                className="block hover:text-primary xl:hidden ltr:mr-5 rtl:ml-5"
              >
                <IconMenu />
              </button>
              <div>
                <div className="flex items-center">
                  ...
                  <div className="text-xs font-semibold  text-white-dark">
                    ({currentCoin.alias})
                  </div>
                </div>
                <div
            ...
            <ul className="mt-5 grid grid-cols-2 divide-[#ebedf2] font-semibold text-white-dark dark:divide-[#253b5c] sm:mt-0 sm:grid-cols-4 sm:divide-x ltr:md:ml-auto rtl:divide-x-reverse rtl:md:mr-auto">
