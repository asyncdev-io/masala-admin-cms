        ...
        <div className="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="panel h-full">
            ...
            <div className=" my-10 text-3xl font-bold text-[#e95f2b]">
              <span>$ 45,141 </span>
              <span className="text-sm text-black dark:text-white-light ltr:mr-2 rtl:ml-2">
                this week
              </span>
          ...
          >
            ...
            <div className="z-10 flex items-center justify-between">
              ...
              <button
                type="button"
                className="z-10 rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4] hover:bg-[#4361ee]"
              >
                Upgrade
              </button>
            </div>
          ...
          <div className="panel h-full">
            ...
            <div>
              ...
              <div className="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                ...
                <button
                  type="button"
                  className="flex items-center rounded-md bg-success/30 px-1.5 py-1 text-xs text-success hover:shadow-[0_10px_20px_-10px] hover:shadow-success"
                >
                  Read More
            ...
            <div className="-m-5 mb-5 flex items-center justify-between border-b border-white-light p-5 dark:border-[#1b2e4b]">
              ...
              <div className="dropdown">
                <Dropdown
                  ...
                  btnClassName="hover:text-primary"
                  button={
                    <IconHorizontalDots className="h-5 w-5 text-black/70 hover:!text-primary dark:text-white/70" />
                  }
                >
                  <ul>
                    <li>
